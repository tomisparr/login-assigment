...
export default function AddOn({ onBackSelectPlan,
onNextAddOns2,
onChangePage1,
onChangePage2,
onChangePage3,
    ...
    <div className={style.container}>
      <div className={style.sideimg}>
        ...
        <div className={style.step}>
          ...
          <div className={style.steporder}>
            <div className={style.num}>
              <button className={style.nu} onClick={onChangePage3}>3</button>
            </div>
            <div className={style.order}>
              <p>step 3</p>
              <span>add-ons</span>
      ...
      <div className={style.personal}>
        ...
        <div className={style.addbutton}>
          <button className={style.back} onClick={onBackSelectPlan}>
            Go Back
          </button>
          <button className={style.next} onClick={onNextAddOns2}>
            Next Step
          </button>
        </div>
      </div>
